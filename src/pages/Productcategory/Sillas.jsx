...
// Productos locales con imágenes (puedes agregar más aquí)
const productosLocales = [
  { imagen: '/images/sillas/silla_gamer.png', nombre: "Silla Gamer Reclinable" },
];
  ...
  useEffect(() => {
    const obtenerProductos = async () => {
      try {
        ...
        const productosFiltrados = res.data.filter(p => Number(p.categoria_id) === 3);
